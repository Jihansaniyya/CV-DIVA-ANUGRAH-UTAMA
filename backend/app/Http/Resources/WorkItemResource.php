...
class WorkItemResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'period_mulai_id' => $this->period_mulai_id,
            'period_selesai_id' => $this->period_selesai_id,
            'periode_mulai' => $this->periodMulai?->nama_periode,
            'periode_selesai' => $this->periodSelesai?->nama_periode,
            'urutan' => $this->urutan,
